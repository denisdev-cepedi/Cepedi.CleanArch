...
public class CepediMensagemError
{
    public static readonly ResponseError Generico = new()
    {
    ...
    public static readonly ResponseError SemResultados = new()
    {
        Titulo = "Sua busca não obteve resultados",
        Descricao = "Tente buscar novamente",
        Tipo = ETipoErro.Aviso
    };

    public static ResponseError ErroGravacaoUsuario = new()
    {
